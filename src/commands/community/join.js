...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const authUrl = `https://www.strava.com/oauth/authorize?client_id=${clientId}&response_type=code&redirect_uri=${redirectUri}&state=${authorId}&approval_prompt=force`;
